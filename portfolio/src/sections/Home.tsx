    ...
    <div className="relative h-screen w-full">
      <div className="absolute top-1/2 -translate-y-1/2 left-24">
        <div className="flex mb-3">
          ...
          <div className="bg-green-200 mr-3 rounded-full inline-block w-2 h-2 md:h-3 md:w-3 lg:h-4 lg:w-4 "></div>
        </div>
        <div className="flex mb-3">
        ...
        <div className="flex mb-3">
          <div className=" mr-3 h-2 md:h-3 lg:h-4 w-36 bg-white"></div>
          <div className="bg-white mr-2 rounded-full inline-block w-3 h-3 lg:h-4 lg:w-4 "></div>
        </div>
        <div className="flex mb-3">
          <div className=" mr-3 h-2 md:h-3 lg:h-4 w-28 bg-white"></div>
          <div className=" mr-3 h-2 md:h-3 lg:h-4 w-12 bg-white"></div>
          <div className=" mr-3 h-2 md:h-3 lg:h-4 w-48 bg-white"></div>
        </div>
        <div className="mb-3 h-2 md:h-3 lg:h-4"></div>
        <div className="flex mb-3">
          <div className=" mr-3 h-2 md:h-3 lg:h-4 w-36 bg-white"></div>
        ...
        <div className="flex mb-3">
          <div className=" mr-3 h-2 md:h-3 lg:h-4 w-56 bg-white"></div>
        </div>
        <div className="flex mb-3">
          <div className="min-w-4 mr-3 h-2 md:h-3 lg:h-4 w-16 bg-green-50"></div>
          <div className="min-w-3 mr-3 h-2 md:h-3 lg:h-4 w-4 bg-green-400"></div>
