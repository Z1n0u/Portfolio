  ...
  return (
    <div id="work" className="relative w-[80%] left-24">
      ...
      <ul className="pt-4 pb-4 relative">
        <li>
          <motion.a
            ...
            initial="hidden"
            whileHover="visible"
            href="https://dorodz.com"
          >
            <motion.span
              variants={variantforbar}
              className="h-4 bg-gradient-to-r from-fuchsia-500 to-pink-500"
            ></motion.span>
            <span className="text-lg text-white test">Doro App</span>
            ...
            <motion.span
              variants={variantforsmalltest}
              className="text-white opacity-50 hover:opacity-100"
            >
              a donations systeme for Algerian streamers
            </motion.span>

            <motion.div
              variants={variantforshowcaseDiv}
              transition={{ duration: 1, ease: "easeInOut" }}
              className="flex bg-black w-96 h-44 absolute top-0 right-[5%]"
            >
        ...
        <li>
          ...
          >
            <motion.span
              ...
              className="h-4 bg-gradient-to-r from-fuchsia-500 to-pink-500"
            ></motion.span>
            <span className="text-lg text-white test">
      ...
      <ul className="pt-4 pb-4 relative">
        <li>
          <motion.a
            href="https://lugx-ten.vercel.app"
            target="_blank"
            className="flex items-center gap-3"
            initial="hidden"
            whileHover="visible"
        ...
        <li>
          <motion.a
            href="https://z1n0u.github.io/E-commerce-sneakers/"
            target="_blank"
            className="flex items-center gap-3"
            initial="hidden"
            whileHover="visible"
